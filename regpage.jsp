...
<div class="bg">
  <div class="main">
    <header>
      <div class="row-1">
          <h1 style="color:red; font-size: 28px;">FRIENDBOOK:<br> <br>A SOCIAL NETWORK FRIEND SUGGESTION TOOL BASED ON SEMANTICS</h1>      
      </div>   
         <div class="row-2">
        <nav>
          <ul class="menu">
...
Interest:<br><select name="loc" id="loc" style="background:  #aaa; height: 28px;  width:250px;">
    <option>Studied in Seshadripuram main college</option>
    <option>Lives in Australia</option>
    <option>Senior Specialist at Fidelity Investments</option>
    <option>From Mysore,Karnataka</option>
    <option>Works at Infosys</option>
